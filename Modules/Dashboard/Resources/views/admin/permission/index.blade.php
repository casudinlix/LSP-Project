...
<div class="row">
    <div class="col-xs-12">
        <h3 class="header smaller lighter blue">Permission List</h3>
...
@endsection
@section('modal')
<div class="modal fade animated bounceInDown" id="myModal" role="dialog" aria-labelledby="modal-large"
    aria-hidden="true">
            ...
            action: function ( e, dt, node, config ) {
                dt.ajax.reload();
          ...
          },
					  {
						...
						"text": "<i class='fa fa-plus-circle bigger-110 blue'></i> <a href='{{route('user.create')}}' class='hidden' data-remote='false' data-target='#myModal' data-toggle='modal'>New Permission</a>",
						"className": "btn btn-white btn-primary btn-bold",
            action: function (e, node, config){
              $('#myModal').modal('show').find(".modal-content").load('{{route('permission.create')}}')
            },
...
function hapus(id)
{
  ...
  setTimeout(function () {
    $.ajax({
      url: '{{url("administrator/permission/")}}/'+id,
      type: 'POST',
      method:'DELETE',
      dataType: 'JSON',
      data: {id: id},
