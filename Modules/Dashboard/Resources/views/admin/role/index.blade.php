            ...
            action: function ( e, dt, node, config ) {
                dt.ajax.reload();
          ...
          },
					  {
						...
						"text": "<i class='fa fa-plus-circle bigger-110 blue'></i> <a href='{{route('role.create')}}' class='hidden' data-remote='false' data-target='#myModal' data-toggle='modal'>New Role</a>",
						"className": "btn btn-white btn-primary btn-bold",
            action: function (e, node, config){
              $('#myModal').modal('show').find(".modal-content").load('{{route('role.create')}}')
            },
