<form class="" action="{{route('produk.update',[$data->id])}}" method="post" id="form_user">
    @csrf
    @method('PUT')
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-7">
                <div class="form-group">
                    ...
                    <div>
                        <input type="text" class="form-control" value="{{$data->kode}}" name="kode" id='kode'
                            required />
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div>
                        <input type="number" class="form-control" value="{{$data->stok}}" name="stok" id='stok' />
                    </div>
                </div>
                <div class="form-group">
...
$.ajax({
  url: '{{route('produk.update',[$data->id])}}',
  type: 'POST',
  method:'PUT',
  dataType: 'JSON',
  data: formdata,
