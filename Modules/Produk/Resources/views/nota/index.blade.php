...
<link rel="stylesheet" href="{{asset('box/jquery.fancybox.min.css')}}">
@endsection
@section('atas')
...
<div class="row">
    <div class="col-xs-12">
        <h3 class="header smaller lighter blue">Nota List</h3>
            ...
            <table id="user" class="table table-striped table-bordered table-hover">
                <thead>
                    <tr>
                        ...
                        <th>Kode Barang</th>
                        <th>Nama Barang</th>
                        <th class="d-none d-sm-table-cell">Total Beli</th>
                        <th class="d-none d-sm-table-cell">Harga</th>
                        <th class="d-none d-sm-table-cell" style="width: 15%;">Tgl pembelian</th>
