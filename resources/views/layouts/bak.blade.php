...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="no-focus">
    ...
    <body>
        ...
        <div id="page-container" class="sidebar-o sidebar-inverse page-header-inverse page-header-fixed enable-page-overlay side-scroll page-header-modern main-content-boxed">
            <!-- Side Overlay-->
          ...
          @include('layouts.patial.menu')
            ...
            <main id="main-container">
                ...
                <!-- Page Content -->
                <div class="content animated lightSpeedIn">
                  @yield('content')
            ...
            <footer id="page-footer" class="opacity-0">
                <div class="content py-20 font-size-xs clearfix">
                    <div class="float-right">
                        Develop <i class="fa fa-heart text-pulse"></i> by <a class="font-w600" href="https://casudinlix.github.io/" target="_blank">Casudin</a>
                    </div>
                    <div class="float-left">
                        <a class="font-w600" href="#" target="_blank">{{config('app.name')}}</a> &copy; v{{config('app.version')}} <span class="js-year-copy">{{date('Y')}} </span>
                    </div>
                </div>
            </footer>
            <!-- END Footer -->
